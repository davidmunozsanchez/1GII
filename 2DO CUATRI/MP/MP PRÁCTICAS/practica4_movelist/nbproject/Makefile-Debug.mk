...
LDLIBSOPTIONS=/usr/local/lib/liblanguage.a /usr/local/lib/libwordlist.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica4_movelist

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica4_movelist: /usr/local/lib/liblanguage.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica4_movelist: /usr/local/lib/libwordlist.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica4_movelist: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica4_movelist ${OBJECTFILES} ${LDLIBSOPTIONS}
