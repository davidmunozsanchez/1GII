...
private:
	...
	void copy(const Movelist& ml);
        /**
         * @brief Redimension an existinG set of movements
         * @param v The set of movements
         * @param size The size of this set
         * @param increment The size we want to redimension (can be positive or negative)
         */
        void redimension (int increment);
