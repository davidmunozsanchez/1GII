...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica6_final

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica6_final: /usr/local/lib/liblanguage.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica6_final: /usr/local/lib/libwordlist.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica6_final: /usr/local/lib/libansiterminal.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica6_final: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica6_final ${OBJECTFILES} ${LDLIBSOPTIONS}
